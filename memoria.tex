...
pdftitle={Memoria}, 
pdfauthor={Alonso Gonzalez}, 
pdfsubject={Criptografía}, pdfkeywords={criptografía, anonimato, autentificación},
pdfcreator={Alonso González}]{hyperref}
...
\newcommand{\encscm}{\mathcal{E}}
\newcommand{\adv}{\mathcal{A}}
\newcommand{\advindcpa}[3]{\mathrm{Adv}^\mathrm{IND-CPA}_{#1,#2}(#3)}
...
%% C. Titulo
\title{Autentificación Desmentible en Canales Anónimos}
...
\profint{Rodrigo Paredes Moraleda} %profesor integrante
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Resumen ejecutivo
\input{./capitulos/resumen_ejecutivo.tex}
...
\input{./capitulos/modelo_criptografico.tex}
\input{./capitulos/desmentibilidad.tex}
\input{./capitulos/anonimato.tex}
